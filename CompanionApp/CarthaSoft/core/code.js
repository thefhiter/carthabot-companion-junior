...
Code.resizeContent = (_navigation) => {
  Code.current.forEach (key => {
    switch (key) {
      case "blocks":
        setTimeout(()=>{Blockly.svgResize(Code.workspace)}, 500)
        break
      case "device":
        break
    }
...
Code.init = function() {
  ...
  Code.workspace = Blockly.inject('content_blocks',
      ...
      // Function to set background image and opacity
...
*/
      ...
      if (lib == "ssd1306") {
        ...
        } else if(lib == "lis2hh12"){
          lib = "lis2hh12"
          reader.readAsText(lis2hh12Blob);
        }
         else {
...
`;
    ...
    installCmd = installCmd + "bipesInstall('file:///D:/Samer/Others/Perso/BIPES/BIPES/ui/pylibs/ + lib, lib)";
