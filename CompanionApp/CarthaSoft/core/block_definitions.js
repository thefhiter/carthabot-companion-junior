Blockly.Blocks['Read_Data_from_IR'] = {
  init: function() {
    this.appendDummyInput()
      .appendField(new Blockly.FieldImage("media/SVG/7.IR_W.svg", 20, 20, "*")) // Adds the icon
      .appendField(new Blockly.FieldLabelSerializable(MSG["readfromir"]));
    
    // Add a numeric input field for the timeout
    this.appendValueInput("TIMEOUT")
      .setCheck("Number")
      .appendField(MSG["timeout"]);
      this.appendDummyInput()
      .appendField(MSG["infinetduration"]);

    this.setOutput(true, null);
    this.setColour("#951b81");
  }
};
  ...
  Blockly.Blocks['Init_IR'] = {
    init: function() {
      this.setColour("#951b81");
      this.appendDummyInput().appendField(new Blockly.FieldImage("media/SVG/7.IR_W.svg", 20, 20, "*")) // Adds the icon   
          .appendField(MSG["initIrRec"]);
  ...
  Blockly.Blocks['GetIfButtonPressed'] = {
    init: function() {
      this.setColour("#009fe3");
      this.appendDummyInput()
          .appendField(new Blockly.FieldImage("media/SVG/5.Buttons_W.svg", 20, 20, "*")) // Adds the icon
          .appendField(MSG["checkbutton"])
      ...
      this.setOutput(true, 'Boolean'); // Set output type to Boolean
      this.setTooltip('Check if the selected button is pressed.');
    }
  };

  Blockly.Blocks['GetObstaclSensorState'] = {
    init: function() {
      this.setColour("#951b81");
      this.appendDummyInput()
          .appendField(new Blockly.FieldImage("media/SVG/6.Capteurs_W.svg", 20, 20, "*")) // Adds the icon
          .appendField(MSG["checkobstaclsensor"])
          .appendField(new Blockly.FieldDropdown([
            ["1", "1"],
            ["2", "2"],
            ["3", "3"],
  ...
  Blockly.Blocks['GetLineSensorState'] = {
    init: function() {
      this.setColour("#951b81");
      this.appendDummyInput()
          .appendField(new Blockly.FieldImage("media/SVG/8.Swiveur_W.svg", 20, 20, "*")) // Adds the icon
          .appendField(MSG["checkgroundsensor"])
          .appendField(new Blockly.FieldDropdown([
            ["1", "1"],
            ["2", "2"],
          ]), "SENSOR");
...
Blockly.Blocks['Init_Accelerometre'] = {
  init: function() {
    this.setColour("#00a19a");
    this.appendDummyInput().appendField(new Blockly.FieldImage("media/SVG/12.Accéléromètre_W.svg", 20, 20, "*")) // Adds the icon   
        .appendField(MSG["initAccel"]);
...
Blockly.Blocks['Accelerometre_read_acc_x'] = {
  init: function() {
    this.appendDummyInput().appendField(new Blockly.FieldImage("media/SVG/12.Accéléromètre_W.svg", 20, 20, "*")) // Adds the icon   
        
    .appendField(MSG["acceX"]);
...
Blockly.Blocks['Accelerometre_read_acc_y'] = {
  init: function() {
    this.appendDummyInput().appendField(new Blockly.FieldImage("media/SVG/12.Accéléromètre_W.svg", 20, 20, "*")) // Adds the icon   
    .appendField(MSG["acceY"]);
        this.setOutput(true, Number);
    this.setColour("#00a19a");
...
Blockly.Blocks['Accelerometre_read_acc_z'] = {
  init: function() {
    this.appendDummyInput().appendField(new Blockly.FieldImage("media/SVG/12.Accéléromètre_W.svg", 20, 20, "*")) // Adds the icon   
    .appendField(MSG["acceZ"]);
        this.setOutput(true, Number);
    this.setColour("#00a19a");
...
Blockly.Blocks['Accelerometre_read_acc_x_g'] = {
  init: function() {
    this.appendDummyInput()
        .appendField(new Blockly.FieldImage("media/SVG/12.Accéléromètre_W.svg", 20, 20, "*")) // Adds the icon   
        .appendField(MSG["acceXg"]);
        this.setOutput(true, 'Number');
    this.setColour("#00a19a");
    this.setTooltip("Acceleration in g on X axis");
    this.setHelpUrl("http://www.bipes.net.br");
  }
};

Blockly.Blocks['Accelerometre_read_acc_y_g'] = {
  init: function() {
    this.appendDummyInput()
        .appendField(new Blockly.FieldImage("media/SVG/12.Accéléromètre_W.svg", 20, 20, "*")) // Adds the icon   
        .appendField(MSG["acceYg"]);
    this.setOutput(true, 'Number');
    this.setColour("#00a19a");
    this.setTooltip("Acceleration in g on Y axis");
    this.setHelpUrl("http://www.bipes.net.br");
  }
};

Blockly.Blocks['Accelerometre_read_acc_z_g'] = {
  init: function() {
    this.appendDummyInput()
        .appendField(new Blockly.FieldImage("media/SVG/12.Accéléromètre_W.svg", 20, 20, "*")) // Adds the icon   
        .appendField(MSG["acceZg"]);
    this.setOutput(true, 'Number');
    this.setColour("#00a19a");
    this.setTooltip("Acceleration in g on Z axis");
    this.setHelpUrl("http://www.bipes.net.br");
  }
};

Blockly.Blocks['InitSDCard'] = {
  init: function() {
    this.setColour("#A89167");

    // Adding the image with inline styling for margin/padding
    this.appendDummyInput()
        .appendField(new Blockly.FieldImage("media/SVG/13.SD card_W.svg", 20, 20, "*"))
        .appendField("Init SD Card");
...
Blockly.Blocks['UnMountSDCard'] = {
  init: function() {
    ...
    this.appendDummyInput()
        .appendField(new Blockly.FieldImage("media/SVG/13.SD card_W.svg", 20, 20, "*"))
        .appendField("Unmount the SD Card");
...
Blockly.Blocks['ReadLineFromFile'] = {
  init: function() {
      this.appendDummyInput().appendField(new Blockly.FieldImage("media/SVG/13.SD card_W.svg", 20, 20, "*"));
      this.appendValueInput("LINENUMBER")
      .setCheck("Number")
      .appendField(MSG["readline"]);
      this.appendDummyInput();
    this.appendValueInput("FILENAME")
            .setCheck("String")
            .appendField(MSG["filename"]);
      this.setOutput(true, 'String');
      this.setColour("#A89167");
      this.setTooltip('Reads a specific line from a file.');
  }
};

Blockly.Blocks['CreateFile'] = {
  init: function() {
    this.appendDummyInput()
        .appendField(new Blockly.FieldImage("media/SVG/13.SD card_W.svg", 20, 20, "*"))
        .appendField(MSG["creatfile"]);
    ...
    this.setNextStatement(true);
    this.setColour("#A89167");
    this.setTooltip('Creates a file');
  }
};
...
Blockly.Blocks['DeleteFile'] = {
  init: function() {
    ...
    this.setNextStatement(true);
    this.setColour("#A89167");
    this.setTooltip('Deletes the specified file.');
  }
};
Blockly.Blocks['ClearFile'] = {
  init: function() {
    this.appendDummyInput()
        .appendField(new Blockly.FieldImage("media/SVG/13.SD card_W.svg", 20, 20, "*"))
        .appendField(MSG["clearfile"]);
...
Blockly.Blocks['WriteToFile'] = {
  init: function() {
    this.appendDummyInput()
        .appendField(new Blockly.FieldImage("media/SVG/13.SD card_W.svg", 20, 20, "*"))
        .appendField(MSG["writefile"]);

    this.appendDummyInput()
        .appendField("Mode")
        .appendField(new Blockly.FieldDropdown([[MSG["write"], "w"], [MSG["append"], "a"]]), "MODE");  // Dropdown for mode selection
...
Blockly.Blocks['ListFiles'] = {
	init: function() {
	  this.appendDummyInput()
		  .appendField(new Blockly.FieldImage("media/SVG/13.SD card_W.svg", 20, 20, "*"))
		  .appendField(MSG["listfiles"]);

  
	  this.setOutput(true, 'Array');
	  this.setColour("#A89167");
	  this.setTooltip('Lists all files in the specified directory.');
	}
  };

Blockly.Blocks['SDCardMountBlock'] = {
	init: function() {
	  this.setColour("#A89167");
	  ...
	  this.appendDummyInput()
		  .appendField(new Blockly.FieldImage("media/SVG/13.SD card_W.svg", 20, 20, "*"))
		  .appendField(MSG["usethesdcard"]);
  
	  // Add a statement input to allow other blocks inside
	  this.appendStatementInput("DO")
		  .setCheck(null)
		  .appendField(MSG["do"]);
  
	  // Add a field to specify the mount path
	  this.appendDummyInput()
		  .appendField(MSG["mountpath"])
		  .appendField(new Blockly.FieldTextInput("/sd"), "MOUNT_PATH");
  
	  this.setPreviousStatement(true);
	  this.setNextStatement(true);
	  this.setTooltip('Mounts the SD card and executes the enclosed blocks. Unmounts afterwards.');
	}
  };


Blockly.Blocks['ReadFromFile'] = {
  init: function() {
    this.appendDummyInput()
      .appendField(new Blockly.FieldImage("media/SVG/13.SD card_W.svg", 20, 20, "*")) // Adds the icon
      .appendField(new Blockly.FieldLabelSerializable(MSG["readfilecontent"]));
    
    // Add a string input field for the file name
    this.appendDummyInput();
    this.appendValueInput("FILENAME")
      .setCheck("String")
		  .appendField(MSG["filename"]);
    ...
    // Set the output type and block color
    this.setOutput(true, "String");
    this.setColour("#A89167");
  }
};
...
Blockly.Blocks['CountLinesInFile'] = {
  init: function() {
    this.setColour("#A89167");
    ...
    this.appendDummyInput()
        .appendField(new Blockly.FieldImage("media/SVG/13.SD card_W.svg", 20, 20, "*"))
        .appendField(MSG["countlineinfile"]);

    // Add a field for the filename input
    this.appendValueInput("FILENAME")
        .setCheck("String")
        .appendField(MSG["filename"]);

    this.setOutput(true, "Number");
    this.setTooltip('Returns the number of lines in the specified file.');
  }
};
...
Blockly.Blocks['Init_Motor_Left'] = {
  init: function() {
    this.appendDummyInput()
      .appendField(new Blockly.FieldImage("media/SVG/01.MotorL_W.svg", 20, 20, "*")) // Adds the icon   

        .appendField(MSG["initMotorLeft"]);


    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setColour("#e94e1b");
  }
};



Blockly.Blocks['Init_Motor_Right'] = {
  init: function() {
    this.appendDummyInput().appendField(new Blockly.FieldImage("media/SVG/02.MotorR_W.svg", 20, 20, "*")) // Adds the icon 
            .appendField(MSG["initMotorRight"]);
...
Blockly.Blocks['Start_Motor_Left'] = {
  init: function() {
    this.appendDummyInput().appendField(new Blockly.FieldImage("media/SVG/01.MotorL_W.svg", 20, 20, "*")) // Adds the icon  
    
        .appendField(MSG["startMotorLeft"])
...
Blockly.Blocks['Start_Motor_Right'] = {
  init: function() {
    this.appendDummyInput().appendField(new Blockly.FieldImage("media/SVG/02.MotorR_W.svg", 20, 20, "*")) // Adds the icon 
        .appendField(MSG["startMotorRight"])
        .appendField(new Blockly.FieldDropdown([[MSG["forward"], "FORWARD"], [MSG["backward"], "BACKWARD"]]), "DIRECTION");
    this.appendValueInput("SPEED")
        .setCheck("Number")
        .appendField(MSG["speed"]);
...
Blockly.Blocks['Stop_Motor_Left'] = {
  init: function() {
    this.appendDummyInput().appendField(new Blockly.FieldImage("media/SVG/01.MotorL_W.svg", 20, 20, "*")) // Adds the icon  
    .appendField(MSG["stopMotorLeft"])
...
Blockly.Blocks['Stop_Motor_Right'] = {
  init: function() {
    this.appendDummyInput().appendField(new Blockly.FieldImage("media/SVG/02.MotorR_W.svg", 20, 20, "*")) // Adds the icon 
    .appendField(MSG["stopMotorRight"])
...
Blockly.Blocks['Change_Speed_Motor_Left'] = {
  init: function() {
    this.appendDummyInput()
        .appendField(new Blockly.FieldImage("media/SVG/01.MotorL_W.svg", 20, 20, "*")) // Adds the icon (change to your image if needed)
        .appendField(MSG["setmotorLeft"]);
    this.appendValueInput("SPEED")
        .setCheck("Number")
        .appendField(MSG["speed"]);
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setColour("#e94e1b"); // Set the block color
  }
};


Blockly.Blocks['Change_Speed_Motor_Right'] = {
  init: function() {
    this.appendDummyInput()
        .appendField(new Blockly.FieldImage("media/SVG/02.MotorR_W.svg", 20, 20, "*")) // Adds the icon (change to your image if needed)
        .appendField(MSG["setmotorRight"]);
        this.appendValueInput("SPEED")
        .setCheck("Number")
        .appendField(MSG["speed"]);
    this.setPreviousStatement(true, null);
...
Blockly.Blocks['Reverse_Motor_Left'] = {
  init: function() {
    this.appendDummyInput().appendField(new Blockly.FieldImage("media/SVG/01.MotorL_W.svg", 20, 20, "*")) // Adds the icon  
        .appendField(MSG["reverseLeft"]);
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setColour("#e94e1b");
  }
};
Blockly.Blocks['Reverse_Motor_Right'] = {
  init: function() {
    this.appendDummyInput().appendField(new Blockly.FieldImage("media/SVG/02.MotorR_W.svg", 20, 20, "*")) // Adds the icon 
    .appendField(MSG["reverseRight"]);
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setColour("#e94e1b");
...
Blockly.Blocks['Read_temp_c'] = {
  init: function() {
    this.appendDummyInput().appendField(new Blockly.FieldImage("media/SVG/9.Temp_W.svg", 20, 20, "*")) // Adds the icon 
        .appendField(MSG["readTempr"]);
    this.appendDummyInput()
        .appendField(MSG["unit"])
        .appendField(new Blockly.FieldDropdown([["Celsius", "C"], ["Fahrenheit", "F"]]), "UNIT");
    this.appendValueInput("TEMP_VAR")
        .setCheck("Variable")
...
Blockly.Blocks['delay_ms'] = {
  init: function() {
    this.appendValueInput("time")
        .setCheck("Number")
        .appendField(MSG["block_delay_ms"]);
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setColour("#8D8A8A");
...
Blockly.Blocks['delay_us'] = {
  init: function() {
    this.appendValueInput("time")
        .setCheck("Number")
        .appendField(MSG["block_delay_micros"]);
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setColour("#8D8A8A");
...
Blockly.Blocks['ticks_ms'] = {
  init: function() {
    this.appendDummyInput()
        .appendField(new Blockly.FieldLabelSerializable(MSG["block_delay_Get_milis_counter"]), "MSG_GET_MS");
    this.setOutput(true, null);
    this.setColour("#8D8A8A");
...
Blockly.Blocks['ticks_diff'] = {
  init: function() {
   this.appendDummyInput().appendField(new Blockly.FieldLabelSerializable(MSG["block_delay_Compute_time_difference"]), "DIFF_TS");
    this.setOutput(true, null);
...
Blockly.Blocks['timer'] = {
  init: function() {
    ...
    this.appendDummyInput()
        ...
        .appendField(MSG["do"])
        .appendField(new Blockly.FieldDropdown([[MSG["every"],"PERIODIC"], [MSG["oncein"],"ONE_SHOT"]]), "MODE")
...
Blockly.Blocks['neopixel_init'] = {
  init: function() {
    this.setColour("#e71d73");
    this.appendDummyInput()
        .appendField(new Blockly.FieldImage("media/SVG/3.LEDS_W.svg", 20, 20, "*")) // Adds the icon
        .appendField(MSG["initRGB"]);
...
Blockly.Blocks['neopixel_control'] = {
  init: function() {
    this.appendDummyInput()
        .appendField(new Blockly.FieldImage("media/SVG/3.LEDS_W.svg", 20, 20, "*")) // Adds the icon
        .appendField(new Blockly.FieldLabel("Control Led"), "MSG_NEOPIXEL");



    this.appendValueInput("address")
        .setCheck(null)
	      .appendField(MSG["ledNumber"]);
...
Blockly.Blocks['neopixel_write'] = {
  init: function() {
    this.appendDummyInput()
        .appendField(new Blockly.FieldImage("media/SVG/3.LEDS_W.svg", 20, 20, "*")) // Adds the icon
        .appendField(new Blockly.FieldLabel(MSG["write"]), "MSG_NEOPIXEL");

    this.setPreviousStatement(true);
    this.setNextStatement(true);

    this.setColour("#e71d73");
    this.setTooltip("Write RGB Values");
    this.setHelpUrl("http://www.bipes.net.br");
  }
};
...
Blockly.Blocks['tone'] = {
  init: function(){
    this.appendDummyInput()
        .appendField(new Blockly.FieldImage("media/SVG/11.Speaker_W.svg", 20, 20, "*")) // Adds the icon
        .appendField(MSG["tone"]);
    this.appendValueInput("frequency")
        .setCheck("Number")
...
Blockly.Blocks['tone_type'] = {
  init: function() {
    this.appendDummyInput().appendField(new Blockly.FieldImage("media/SVG/14.Note_W.svg", 20, 20, "*")) // Adds the icon
...
Blockly.Blocks['GetSongs'] = {
  init: function() {
    this.appendDummyInput()
    .appendField(new Blockly.FieldImage("media/SVG/14.Note_W.svg", 20, 20, "*")) // Adds the icon
        .appendField(MSG["MusicOptions"]);
...
Blockly.Blocks['SelectSong'] = {
  init: function() {
    this.appendDummyInput()
    .appendField(new Blockly.FieldImage("media/SVG/14.Note_W.svg", 20, 20, "*")) // Adds the icon
        .appendField(MSG["music"])
        .appendField(new Blockly.FieldDropdown([
          ["Super Mario - Main Theme", "SUPER_MARIO_MAIN"],
          ["Super Mario - Title Music", "SUPER_MARIO_TITLE"],
          ["SMBtheme", "SMB_THEME"],
          ["SMBwater", "SMB_WATER"],
          ["SMBunderground", "SMB_UNDERGROUND"],
          ["Picaxe", "PICAXE"],
          ["Simpsons", "SIMPSONS"],
          ["Indiana", "INDIANA"],
          ["TakeOnMe", "TAKE_ON_ME"],
          ...
          ["Gadget", "GADGET"],
          ["Smurfs", "SMURFS"],
          ["MahnaMahna", "MAHNA_MAHNA"],
          ["LeisureSuit", "LEISURE_SUIT"],
          ["MissionImp", "MISSION_IMP"]
        ]), "MUSIC");
...
Blockly.Blocks['ReadMicrophoneValue'] = {
  init: function() {
    this.appendDummyInput()
        .appendField(new Blockly.FieldImage("media/SVG/10.Micro_W.svg", 20, 20, "*")) // Adds the icon
        .appendField(MSG["readmicValue"]);

    this.setOutput(true, 'Number'); // Set output type to Number (int)
    this.setColour("#00a19a");
    this.setHelpUrl('');
  }
};

Blockly.Blocks['CompareMicrophoneValue'] = {
  init: function() {
    this.appendDummyInput()
        .appendField(new Blockly.FieldImage("media/SVG/10.Micro_W.svg", 20, 20, "*")) // Adds the icon
        .appendField(MSG["detectsound"]);

    this.appendValueInput("THRESHOLD")
        .setCheck("Number")
        .appendField(MSG["threshold"]);

    this.setInputsInline(false); // Set to false to ensure inputs are not inline
    this.setOutput(true, 'Boolean'); // Set output type to Boolean
    this.setColour("#00a19a");
    this.setHelpUrl('');
  }
...
// "When boot starts" hat – a friendly Scratch-style entry point for the Learn
// editor. Snap your blocks under it; they run when the CarthaBot powers on.
Blockly.Blocks['cartha_on_boot'] = {
  init: function() {
    this.appendDummyInput()
        .appendField("▶ ")
        .appendField(MSG["onBoot"] || "when CarthaBot starts");
    this.setNextStatement(true, null);
    this.setColour("#4CAF50");
    this.setTooltip(MSG["onBootTip"] || "Snap your blocks under here. They run when the CarthaBot turns on.");
    this.setHelpUrl("");
  }
};
