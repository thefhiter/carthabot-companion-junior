...
//Blocks
  ...
  block_delay_ms:"delay milliseconds",
  block_delay_micros:"delay microseconds",
  block_delay_Get_milis_counter: "Get milliseconds counter",
  block_delay_Compute_time_difference: "Compute time difference",
 ...
 checkobstaclsensor:"Check Obstacle Sensor",


  checkgroundsensor:"Check if Sensor detecting ground",

  readTempr:"Read Temperature",
  unit:"Unit",

  onBoot:"when CarthaBot starts",
  onBootTip:"Snap your blocks under here. They run when the CarthaBot turns on.",

  initIrRec:"Init IR Reciever",
  readfromir:"Read data from IR Receiver",
  timeout:"Timeout (ms)",
  infinetduration:"(0 for infinite duration)",
  ...
  initMotorLeft:"Init Motor Left",
  initMotorRight:"Init Motor Right",

  startMotorLeft:"Start Motor Left",
  startMotorRight:"Start Motor Right",

  stopMotorLeft:"Stop Motor Left",
  stopMotorRight:"Stop Motor Right",

  reverseLeft:"Reverse Left Motor",
  reverseRight:"Reverse Right Motor",

  setmotorLeft:"Set Motor Speed Left",
  setmotorRight:"Set Motor Speed Right",
  ...
  readmicValue:"Read Microphone Value",
  ...
  frequency: "Frequency",
  duration: "Duration  (s)",
  playmusic: "Play music note",
  note: "Note",
  playsong: "Play song",
  song: "Song",
  music: "Music",
  MusicOptions: "Music Options List",




  initAccel:"Init Accelerometre",  
  acceX:"Acceleration - X axis",
  acceY:"Acceleration - Y axis",
  acceZ:"Acceleration - Z axis",
  acceXg:"Acceleration in g - X axis",
  acceYg:"Acceleration in g - Y axis",
  acceZg:"Acceleration in g - Z axis",

  usethesdcard:"Use the SD Card",
  mountpath:"Mount Path",
  filename:"File Name",
  countlineinfile:"Count lines in file",
  readfilecontent:"Read file Content",
  listfiles:"List files in SD Card",
  readline:"Read line",
  creatfile:"Create file",
  deletfile:"Delete file",
...
Blockly.Msg['CAT_TEMPERATURE'] = "Temperature";
Blockly.Msg['CAT_IR_RECEIVER'] = "IR Receiver";
Blockly.Msg['CAT_RGB_LED'] = "RGB LED";
Blockly.Msg['CAT_MOTORS'] = "Motors";
Blockly.Msg['CAT_MICROPHONE'] = "Microphone";
Blockly.Msg['CAT_SOUNDS'] = "Sounds";
Blockly.Msg['CAT_ACCELEROMETER'] = "Accelerometer";
Blockly.Msg['CAT_SD_CARD'] = "SD Card";